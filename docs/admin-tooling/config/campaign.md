...
An HTML Variant is the HTML and CSS design of your banner. Visit [/admin/html_variants](/docs/_advanced-customization/html-variants) to design your banner and add the name of the HTML variant to this field.
